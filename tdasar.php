    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Table Dasar</strong>
                        </div>
                    </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <?php 
                    $no=1;
                    $sql="SELECT * FROM dasar";
                    $query=mysqli_query($db,$sql);

                    while ($data=mysqli_fetch_array($query)) {
                        echo "<tr>";
                        echo "<td>".$no."</td>";
                        echo "<td>".$data['nama_dasar']."</td>";
                        echo "<td>".$data['tgl_dasar']."</td>";
                        echo "<td>".$data['no_dasar']."</td>";
                        echo "<td>".$data['peruntukan']."</td>";
                        echo "<td><a href='editdasar.php?kd_dasar=$data[kd_dasar]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-pencil glyphicon-edit'></span> Update</a>
                        <a href='hapusdasar.php?kd_dasar=$data[kd_dasar]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-minus glyphicon-edit'></span>Hapus</a>
                ...
                <tr>
                    <td>
                        <a href='formdasar.php?kd_dasar=$data[kd_dasar]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='glyphicon glyphicon-plus'></span> Tambah dasar
                        </a>
                    </td>
                </tr>
                        </div>
