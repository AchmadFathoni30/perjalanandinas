                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="simpanpegawai.php" method="post" enctype="multipart/form-data" class="form-horizontal">


                          <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="nip" class=" form-control-label">Nomor Induk Pegawai</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <input type="text" name="nip" required="" placeholder="Enter Nomor Induk Pegawai" class="form-control">
                          ...
                          <div class="row form-group">
                           ...
                           <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="nama_lengkap" required="" placeholder="Enter Nama Lengkap" class="form-control">
                                <btn class="form-text text-muted">This is a help text</btn>
                            </div>
                          </div>
                          ...
                          <div class="col col-md-3">
                            ...
                            <div class="col col-md-9">
                              <div class="form-check">
                                <div class="radio">
                                  <label for="golongan" class="form-check-label " required="">
                                    <input type="radio" name="golongan" value="I" class="form-check-input">I
                                  </label>
                                </div>
                        ...
                        <div class="col col-md-9">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="role" readonly="" value="pegawai" placeholder="pegawai" class="form-control">
                                <btn class="form-text text-muted">This is a help text</btn>
                            </div>
                          </div>
