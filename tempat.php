                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Table Tempat</strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    while ($data=mysqli_fetch_array($query)) {
                        ...
                        echo "<td>".number_format($data['tarif_tempat'])."</td>";
                        echo "<td><a href='edittempat.php?kd_tempat=$data[kd_tempat]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-pencil glyphicon-edit'></span>Update</a>
                        <a href='hapustempat.php?kd_tempat=$data[kd_tempat]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-minus glyphicon-edit'></span>Hapus</a>
                        </td>";
                        echo "</tr>";
                        $no=$no+1;
                    }
                  ...
                  <tr>
                    <td>
                        <a href='formtempat.php?kd_tempat=$data[kd_tempat]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='glyphicon glyphicon-plus'></span> Tambah tempat
                        </a>
                    </td>
                </tr>
                        </div>
