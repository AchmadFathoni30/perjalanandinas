                    ...
                    <tbody>
                        <?php
                            ...
                            $sql="SELECT * FROM spt JOIN user ON spt.kd_user=user.kd_user 
                                                    JOIN dasar ON spt.kd_dasar=dasar.kd_dasar WHERE nama_lengkap='$user'";
                            $query=mysqli_query($db,$sql);
                            ...
                            while ($data=mysqli_fetch_array($query)){
                                ...
                                echo "<td><a href='formlpd.php?no_spt=$data[no_spt]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-plus glyphicon-print'></span> Input Laporan</a>
