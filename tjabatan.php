                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    while ($data=mysqli_fetch_array($query)) {
                        ...
                        echo "<td>".$data['uang_harian']."</td>";
                        echo "<td><a href='editjabatan.php?kd_jabatan=$data[kd_jabatan]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-pencil glyphicon-edit'></span>Update</a>
                        </td>";
                        echo "</tr>";
                        $no=$no+1;
                    }
