                      ...
                      <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="simpandasar.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" name="nama_dasar" required="" placeholder="Enter Dasar" class="form-control">
                                        <small class="help-block form-text">Please Enter Dasar</small>
                                    </div>
                                </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="date" name="tgl_dasar" required="" placeholder="Enter Tanggal" class="form-control">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" name="no_dasar" required="" placeholder="Enter Nomor Dasar" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" name="peruntukan" required="" placeholder="Enter Peruntukan" class="form-control">
