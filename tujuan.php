    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    while ($data=mysqli_fetch_array($query)) {
                        ...
                        echo "<td>".number_format($data['tarif_transport'])."</td>";
                        echo "<td><a href='edittujuan.php?kd_tujuan=$data[kd_tujuan]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-pencil glyphicon-edit'></span>Update</a>
                        <a href='hapustujuan.php?kd_tujuan=$data[kd_tujuan]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-minus glyphicon-edit'></span>Hapus</a>
                        </td>";
                        echo "</tr>";
                        $no=$no+1;
                    }
                ...
                <tr>
                    <td>
                        <a href='formtujuan.php?kd_tujuan=$data[kd_tujuan]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='glyphicon glyphicon-plus'></span> Tambah tujuan</a>
                    </td>
                </tr>
                        </div>
                    </div>
