            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <?php 
                    $no=1;
                    $sql="SELECT * FROM user JOIN jabatan ON user.kd_jabatan=jabatan.kd_jabatan";
                    ...
                    while ($data=mysqli_fetch_array($query)) {
                        ...
                        echo "<td><a href='edituser.php?kd_user=$data[kd_user]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-pencil glyphicon-edit'></span>Update</a>
                        <a href='hapuspegawai.php?kd_user=$data[kd_user]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-minus glyphicon-edit'></span>Hapus</a>
                        </td>";
                        echo "</tr>";
                        $no=$no+1;
                    }
                ...
                <tr>
                    <td>
                        <a href='formpegawai.php?kd_user=$data[kd_user]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='glyphicon glyphicon-plus'></span> Tambah pegawai</a>
                    </td>
                </tr>
                        </div>
                    </div>
