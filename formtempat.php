                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="simpantempat.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="nama_tempat" required="" placeholder="Enter Tempat" class="form-control">
                                <small class="help-block form-text">Please Enter Tempat</small>
                            </div>
                          </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="number" name="tarif_tempat" required="" placeholder="Enter Tarif" class="form-control">
                                    <small class="help-block form-text">Please Enter Tarif</small>
                                </div>
                              </div>
