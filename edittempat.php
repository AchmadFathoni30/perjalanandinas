...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <?php
            $kd_tempat = $_GET['kd_tempat'];
            $sql = "SELECT * FROM tempat WHERE kd_tempat='$kd_tempat'";
                      ...
                      <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Form Tempat</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="simpanedittempat.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="nama_tempat" value="<?php echo $data['nama_tempat']; ?>" placeholder="Enter Nama Tempat" class="form-control">
                                <small class="help-block form-text">Please Enter Nama Tempat</small>
                            </div>
                          </div>
                          <div class="row form-group">
                          <div class="col col-md-3">
                              ...
                              <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="tarif_tempat" class=" form-control-label">Tarif Tempat</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" name="tarif_tempat" value="<?php echo $data['tarif_tempat']; ?>" placeholder="Enter Tarif Tempat" class="form-control">
                                    <small class="help-block form-text">Please Enter Tarif Tempat</small>
                                </div>
                              </div>
