...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <?php
            ...
            $sql = "SELECT * FROM tujuan WHERE kd_tujuan='$kd_tujuan'";
                      ...
                      <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Form Edit Tujuan</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="simpanedittujuan.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" name="nama_tujuan" value="<?php echo $data['nama_tujuan']; ?>" placeholder="Enter Nama Tujuan" class="form-control">
                                <small class="help-block form-text">Please Enter Nama Tujuan</small>
                            </div>
                          </div>
                          ...
                          <div class="row form-group">
                            <div class="col col-md-3">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" name="tarif_transport" value="<?php echo $data['tarif_transport']; ?>" placeholder="Enter Tarif Pesawat" class="form-control">
