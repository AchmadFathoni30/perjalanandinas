                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-header">
                        <strong>Form Rekap Biaya Perjalanan Dinas</strong>
                      </div>
                       <div class="card-body card-block">
                    <form action="cetakrekap.php" method="post" enctype="multipart/form-data" class="form-horizontal">

                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="tgl_berangkat" class=" form-control-label">Dari Tanggal</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="date" name="tgl_dari" placeholder="Enter Tanggal Berangkat" class="form-control">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3">
                            <label for="tgl_kembali" class=" form-control-label">Sampai Tanggal</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="date" name="tgl_sampai" placeholder="Enter Tanggal Kembali" class="form-control">
                            <btn class="form-text text-muted">This is a help text</btn>
                        </div>
                    </div>
