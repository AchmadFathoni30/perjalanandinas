                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="twilayah.php">Data Wilayah</a></li>
                        </ul>
                    </li>
                      ...
                      <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="simpaneditjabatan.php" method="post" enctype="multipart/form-data" class="form-horizontal">

                            <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="nama_jabatan" class=" form-control-label">Jabatan</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <input type="text" name="nama_jabatan" value="<?php echo $data['nama_jabatan']; ?>" placeholder="Enter Jabatan" class="form-control">
                                <small class="help-block form-text">Please Enter Jabatan</small>
                            </div>
                          </div>
                          <div class="row form-group">
                          <div class="col col-md-3">
                              ...
                              <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="uang_harian" class=" form-control-label">Uang Harian</label>
                                </div>
                                <div class="col-12 col-md-9">
                                    <input type="text" name="uang_harian" value="<?php echo $data['uang_harian']; ?>" placeholder="Enter Uang Harian" class="form-control">
                                    <small class="help-block form-text">Please Enter Uang Harian</small>
                                </div>
                              </div>
