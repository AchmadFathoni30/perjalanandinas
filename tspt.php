                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Table Surat Perintah Tugas</strong>
                        </div>
                        <div class="card-body">
                    ...
                    <tbody>
                        <?php 
                            ...
                            while ($data=mysqli_fetch_array($query)){
                                ...
                                echo "<td>".date('d-m-Y',strtotime($data['tgl_berangkat']))."</td>";
                                echo "<td>".date('d-m-Y',strtotime($data['tgl_kembali']))."</td>";
                                echo "<td>".$data['dalam_rangka']."</td>";
                                echo "<td>".$data['status']."</td>";
                                echo "<td><a href='editspt.php?no_spt=$data[no_spt]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-pencil glyphicon-print'></span>Update</a>
                                <a href='cetakspt.php?no_spt=$data[no_spt]' target='_blank' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='fa fa-print glyphicon-print'></span>Cetak</a></td>";
                                echo "</tr>";
                                $no=$no+1;
                                  }
                                  ?>
                  ...
                  <tr>
                    <td>
                        <a href='formspt.php?no_spt=$data[no_spt]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='glyphicon glyphicon-plus'></span> Tambah SPT
                        </a>
                    </td>
                </tr>
                        </div>
