                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Table Kwitansi</strong>
                        </div>
                        <div class="card-body">
                  ...
                  <tr><td><a href='formkwitansi.php?kd_kwitansi=$data[kd_kwitansi]' type='button' class='btn btn-default' style='color:white;background-color:green;padding:4px'><span class='glyphicon glyphicon-plus'></span> Tambah kwitansi</a></td></tr>
                        </div>
                    </div>
                </div>
